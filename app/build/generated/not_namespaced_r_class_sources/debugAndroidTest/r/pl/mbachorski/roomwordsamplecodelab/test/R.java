...
public final class R {
  ...
  public static final class style {
    public static final int InstrumentationActivityInvokerBootstrapActivityTheme=0x7f090000;
    public static final int InstrumentationActivityInvokerEmptyActivityTheme=0x7f090001;
    public static final int InstrumentationActivityInvokerFloatingActivityTheme=0x7f090002;
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha pl.mbachorski.roomwordsamplecodelab.test:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name pl.mbachorski.roomwordsamplecodelab.test:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority pl.mbachorski.roomwordsamplecodelab.test:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts pl.mbachorski.roomwordsamplecodelab.test:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy pl.mbachorski.roomwordsamplecodelab.test:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout pl.mbachorski.roomwordsamplecodelab.test:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage pl.mbachorski.roomwordsamplecodelab.test:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery pl.mbachorski.roomwordsamplecodelab.test:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name pl.mbachorski.roomwordsamplecodelab.test:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name pl.mbachorski.roomwordsamplecodelab.test:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name pl.mbachorski.roomwordsamplecodelab.test:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name pl.mbachorski.roomwordsamplecodelab.test:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name pl.mbachorski.roomwordsamplecodelab.test:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name pl.mbachorski.roomwordsamplecodelab.test:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font pl.mbachorski.roomwordsamplecodelab.test:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle pl.mbachorski.roomwordsamplecodelab.test:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings pl.mbachorski.roomwordsamplecodelab.test:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight pl.mbachorski.roomwordsamplecodelab.test:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex pl.mbachorski.roomwordsamplecodelab.test:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name pl.mbachorski.roomwordsamplecodelab.test:font
     */
     ...
     * </table>
     *
     * @attr name pl.mbachorski.roomwordsamplecodelab.test:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name pl.mbachorski.roomwordsamplecodelab.test:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name pl.mbachorski.roomwordsamplecodelab.test:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name pl.mbachorski.roomwordsamplecodelab.test:ttcIndex
     */
